            ...
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="profile-element text-center">
                        <img alt="image" class="img-circle" src="<?=UrlService::buildUrl("/imgs/web/logo.png");?>" />
                ...
                <li class="account">
                    <a href="#"><i class="fa fa-user fa-lg"></i> <span class="nav-label">账号管理</span></a>
                </li>
                <li class="brand">
                    <a href="#"><i class="fa fa-cog fa-lg"></i> <span class="nav-label">品牌设置</span></a>
                </li>
                <li class="book">
                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li class="dropdown user_info">
                        <a  class="dropdown-toggle" data-toggle="dropdown" href="<?=UrlService::buildNullUrl();?>">
                            <img alt="image" class="img-circle" src="<?=UrlService::buildUrl("/imgs/web/avatar.png");?>" />
                        </a>

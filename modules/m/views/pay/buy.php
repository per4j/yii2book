...
<div class="order_box">
    ...
    <div class="fastway_list_box" style="padding-left: 20px;padding-bottom: 0px;">
        <ul class="fastway_list">
            <li><a href="<?=UrlService::buildNullUrl();?>" style="padding-left: 0.1rem;"><span>支付金额：</span></a></li>
            <li><a href="<?=UrlService::buildNullUrl();?>" style="padding-left: 0.1rem;"><span>支付备注：</span></a></li>
        </ul>
    </div>
</div>
<div class="op_box">
